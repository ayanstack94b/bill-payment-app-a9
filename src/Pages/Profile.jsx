    ...
    return (
        ...
        <div className="max-w-md p-8 sm:flex sm:space-x-6 dark:bg-gray-50 dark:text-gray-800 mx-auto my-30">
            <div className="flex-shrink-0 w-full mb-6 h-44 sm:h-32 sm:w-32 sm:mb-0">
                <img src={currentUser?.photoURL} alt="" className="object-cover object-center w-full h-full rounded dark:bg-gray-500" />
            </div>
            <div className="flex flex-col space-y-4">
                ...
                <div className="space-y-1">
                    <span className="flex items-center space-x-2">
                        ...
                        <span className="dark:text-gray-600">{currentUser.email}</span>
                    </span>
                    <span className="flex items-center space-x-2">
